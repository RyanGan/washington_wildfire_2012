...
More referent periods is better for statistical efficiency, but there is a tradeoff, where additional referent periods may introduce what they call 'overlap bias', which they mathmatically define in some of their earlier works. Basically I think if the exposure assigned in the referent period is conditional the strategy used to define the referent period, then this bias is introduced. 
