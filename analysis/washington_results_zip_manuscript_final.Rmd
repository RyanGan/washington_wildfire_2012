...
eco_region_map <- ggmap(washington_map) + 
  geom_polygon(data = eco_region, aes(x=long, y=lat, group = group, fill = group), color = "black", alpha = 0.5) +
  scale_fill_manual(name = "Ecology Regions",
                    values = c("blue","purple","red","yellow"), 
...
plot_print <- ggplot(df_range, aes(x = date)) +
  ...
  scale_fill_manual(name = "Washington State Ecology \n Regional Office Jurisdiction",
                    values = c("red", "yellow", "purple", "blue"),
...
map_timeseries <- plot_grid(eco_region_map, wrf_plot, krig_plot, geo_plot)
#save_plot("map_timeseries.pdf", map_timeseries, 
#          ncol = 2, nrow = 2)
plot(map_timeseries)
```
