...
ggplot(wa_state_aggregate_jul_oct, aes(x = date, y = n)) +
  geom_point() +
  ggtitle("asthma counts for the 2012 fire season")
...
mixed_mod <- tidy(glmer(asthma_n_wo_miss ~ geo_smk_pm_unit10 + wrf_temp + 
                        (1|county), wash_jul_oct_ts_df, family = "poisson"))

mixed_mod

summary(glmer(asthma_n_wo_miss ~ geo_smk_pm_unit10 + wrf_temp + (1|county), 
