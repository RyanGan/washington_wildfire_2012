...
eco_region_map <- ggmap(washington_map) + 
  geom_polygon(data = eco_region, aes(x=long, y=lat, group = group, fill = group), color = "black", alpha = 0.8) +
...
plot_print <- ggplot(df_range, aes(x = date)) +
  geom_ribbon(aes(ymin = min, ymax = max, group = eco_region, fill=eco_region), alpha = 0.7) +
